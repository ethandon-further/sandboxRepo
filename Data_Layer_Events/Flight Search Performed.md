...
Criteria for an Itinerary were sent to the flight booking engine.  Criteria may include journey type (one way, round trip, multi city), departure and arrival airports, travel dates, guest counts, and other info. 
