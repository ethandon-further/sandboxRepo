...
| `product[n].price.sellingPrice` | string | String representation of the price paid after coupons or discounts. Positive. Up to two decimal places for cents. No currency symbol. | 200, 29.99, 50, 0 |
| `product[n].quantity` | integer | Integer number of products being acted upon (added to a cart, removed from wishlist, purchased, reserved) | 1, 2, 3, 4, 5 |
...
User begins the shopping cart checkout process.
